        ...
        def chk_name():
            while True:
                ...
                if len(self.k) != 0 and a != True:
                    self.NAME=self.k
                    self.Text1.insert(INSERT, "NAME HAS BEEN RECORDED.""\n")
                    break
                else:
        ...
        def chk_add():
            while True:
                ...
                if len(self.g)!= 0 and ak!=True:
                    ...
                    self.Text1.insert(INSERT, "ADDRESS HAS BEEN RECORDED.""\n")
                    break
                else:
        ...
        def chk_mo():
            while True:
                ...
                if self.h.isdigit() == True and len(self.h) != 0 and len(self.h) == 10:
                    self.MOBILE = self.h
                    self.Text1.insert(INSERT, "MOBILE NUMBER HAS BEEN RECORDED.""\n")
                    break
                else:
